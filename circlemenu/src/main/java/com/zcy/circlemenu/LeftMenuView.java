...
public class LeftMenuView extends BaseView {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPath.addArc(bigCircle, 135, 90);
        mPath.addArc(smallCircle, 135, 90);
        mInnerPath.addArc(bigCircle, 135, 90);
        mInnerPath.arcTo(smallCircle, 225, -90);
        mInnerPath.close();
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (touchFlag && mOnMenuClickListener != null) {
                    mOnMenuClickListener.onLeftMenuClick();
                }
                touchFlag = false;
                break;
