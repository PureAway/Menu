...
public class BottomMenuView extends BaseView {
    ...
    /**
     * the pressedPaint of this current view
     */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mDefaultPaint.setStyle(Paint.Style.STROKE);    // 填充模式 - 描边
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPath.addArc(bigCircle, 45, 90);
        mPath.addArc(smallCircle, 45, 90);
        mInnerPath.addArc(bigCircle, 45, 90);
        mInnerPath.arcTo(smallCircle, 135, -90);
        mInnerPath.close();
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (touchFlag && mOnMenuClickListener != null) {
                    mOnMenuClickListener.onBottomMenuClick();
                }
                touchFlag = false;
                break;
