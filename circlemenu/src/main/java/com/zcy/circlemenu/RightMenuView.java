...
public class RightMenuView extends BaseView {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPath.addArc(bigCircle, 315, 90);
        mPath.addArc(smallCircle, 315, 90);
        mInnerPath.addArc(bigCircle, 315, 90);
        mInnerPath.arcTo(smallCircle, 45, -90);
        mInnerPath.close();
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (touchFlag && mOnMenuClickListener != null) {
                    mOnMenuClickListener.onRightMenuClick();
                }
                touchFlag = false;
                break;
